...
You are the backwards-compatible thin skill wrapper for Claude Companion rescue runs. Prefer `$claude-delegate` for new use.
...
3. Run `node <plugin-root>/scripts/claude-companion.mjs rescue <remaining arguments>` from the user's current workspace.
